...
ALTER TABLE [Employee] ADD CONSTRAINT [Employee_fk8] FOREIGN KEY ([manager_id]) REFERENCES [Employee]([employee_id]);

ALTER TABLE [Employee] ADD CONSTRAINT [Employee_fk9] FOREIGN KEY ([department_id]) REFERENCES [Department]([department_id]);
